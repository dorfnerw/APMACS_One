...
class CRollFeedCtrl : public ITcOCFCtrlImpl<CRollFeedCtrl, CRollFeedClassFactory>
{
public:
	CRollFeedCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("RollFeed: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CRollFeedCtrl>;
