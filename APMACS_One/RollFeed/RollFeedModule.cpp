...
HRESULT CRollFeedModule::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	...
	//-- Wait till IO sync module indicates that input read is completed. ---
	result = WaitTillInputReady(30);		//-- usec
	if (result)
	{
...
bool CRollFeedModule::WaitTillInputReady(int time_out_usec)
{
	...
	while (!GetInputReadyFlag() && !time_out_flag)
	{
...
bool CRollFeedModule::GetInputReadyFlag()
{
	return(inputReadyFlag);
}
...
void CRollFeedModule::CountInputReadyTimeout()
{
	inputReadyTimeout++;
	m_Outputs.InputReadyTimeoutCount++;			//-- NOTE: 0.1.0.1 Added for debugging
}

bool CRollFeedModule::GetOutputReadyFlag()
{
	return(outputReadyFlag);
}

void CRollFeedModule::SetOutputReadyFlag()
{
	outputReadyFlag = true;
}

void CRollFeedModule::ResetOutputReadyFlag()
{
	outputReadyFlag = false;
}

void CRollFeedModule::CountOutputReadyTimeout()
{
	outputReadyTimeout++;
	m_Outputs.OutputReadyTimeoutCount++;		//-- NOTE: 0.1.0.1 Added for debugging
}
///</AutoGeneratedContent>
