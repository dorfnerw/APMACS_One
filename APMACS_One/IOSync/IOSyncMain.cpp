...
class CIOSyncCtrl : public ITcOCFCtrlImpl<CIOSyncCtrl, CIOSyncClassFactory>
{
public:
	CIOSyncCtrl() {};
	virtual ~CIOSyncCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("IOSync: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CIOSyncCtrl>;
