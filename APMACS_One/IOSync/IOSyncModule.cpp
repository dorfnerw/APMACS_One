...
HRESULT CIOSyncModule::InitIOSyncIntrfPointers()
{
	...
	HRESULT hr = S_OK;
	if (m_spIOSyncIntrf1.HasOID()) { hr = m_spSrv->TcQuerySmartObjectInterface(m_spIOSyncIntrf1); if (hr == S_FALSE) m_spIOSyncIntrf1 = NULL;  }
	if (m_spIOSyncIntrf2.HasOID()) { hr = m_spSrv->TcQuerySmartObjectInterface(m_spIOSyncIntrf2); if (hr == S_FALSE) m_spIOSyncIntrf2 = NULL;  }
	if (m_spIOSyncIntrf3.HasOID()) { hr = m_spSrv->TcQuerySmartObjectInterface(m_spIOSyncIntrf3); if (hr == S_FALSE) m_spIOSyncIntrf3 = NULL;  }
	if (m_spIOSyncIntrf4.HasOID()) { hr = m_spSrv->TcQuerySmartObjectInterface(m_spIOSyncIntrf4); if (hr == S_FALSE) m_spIOSyncIntrf4 = NULL;  }
	if (m_spIOSyncIntrf5.HasOID()) { hr = m_spSrv->TcQuerySmartObjectInterface(m_spIOSyncIntrf5); if (hr == S_FALSE) m_spIOSyncIntrf5 = NULL;  }
	if (m_spIOSyncIntrf6.HasOID()) { hr = m_spSrv->TcQuerySmartObjectInterface(m_spIOSyncIntrf6); if (hr == S_FALSE) m_spIOSyncIntrf6 = NULL;  }
	if (m_spIOSyncIntrf7.HasOID()) { hr = m_spSrv->TcQuerySmartObjectInterface(m_spIOSyncIntrf7); if (hr == S_FALSE) m_spIOSyncIntrf7 = NULL;  }
	if (m_spIOSyncIntrf8.HasOID()) { hr = m_spSrv->TcQuerySmartObjectInterface(m_spIOSyncIntrf8); if (hr == S_FALSE) m_spIOSyncIntrf8 = NULL;  }
	if (m_spIOSyncIntrf9.HasOID()) { hr = m_spSrv->TcQuerySmartObjectInterface(m_spIOSyncIntrf9); if (hr == S_FALSE) m_spIOSyncIntrf9 = NULL;  }
	if (m_spIOSyncIntrf10.HasOID()) { hr = m_spSrv->TcQuerySmartObjectInterface(m_spIOSyncIntrf10); if (hr == S_FALSE) m_spIOSyncIntrf10 = NULL;	}
