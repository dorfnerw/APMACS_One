...
CPressPosModule::CPressPosModule()
	...
	, m_log(0x12C)							//#@@# LTW
	, PressDriveMotionControl(&m_Inputs.PressDriveInputs, &m_Outputs.PressDriveOutputs, &m_PressDriveVariables.DriveCommands, &m_PressDriveVariables.IsRunning, &m_PressDriveVariables.VelocityInRPM, 1048576) //20 bit encoder on Yaskawa motor
{
