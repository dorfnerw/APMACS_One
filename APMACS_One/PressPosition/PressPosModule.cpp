...
///////////////////////////////////////////////////////////////////////////////
// Collection of interfaces implemented by module CPressPosModule
BEGIN_INTERFACE_MAP(CPressPosModule)
...
IMPLEMENT_IPERSIST_LIB(CPressPosModule, VID_PressPosition, CID_PressPositionCPressPosModule)
IMPLEMENT_ITCOMOBJECT(CPressPosModule)
IMPLEMENT_ITCOMOBJECT_SETSTATE_LOCKOP2(CPressPosModule)
IMPLEMENT_ITCADI(CPressPosModule)
IMPLEMENT_ITCWATCHSOURCE(CPressPosModule)

///////////////////////////////////////////////////////////////////////////////
// Set parameters of CPressPosModule 
BEGIN_SETOBJPARA_MAP(CPressPosModule)
	SETOBJPARA_DATAAREA_MAP()
///<AutoGeneratedContent id="SetObjectParameterMap">
	SETOBJPARA_VALUE(PID_TcTraceLevel, m_TraceLevelMax)
	SETOBJPARA_VALUE(PID_PressPosModuleDefaultAdsPort, m_DefaultAdsPort)
	SETOBJPARA_VALUE(PID_Ctx_AdsPort, m_ContextAdsPort)
	SETOBJPARA_VALUE(PID_PressPosModuleCounter, m_Counter)
	SETOBJPARA_VALUE(PID_PressPosModuleMyContextId, m_MyContextId)
	SETOBJPARA_ITFPTR(PID_Ctx_TaskOid, m_spCyclicCaller)
	SETOBJPARA_ITFPTR(PID_PressPosModulePostCyclicCaller, m_spPostCyclicCaller)
	SETOBJPARA_ITFPTR(PID_PressPosModuleIOSyncIntrf1, m_spIOSyncIntrf1)
///</AutoGeneratedContent>
END_SETOBJPARA_MAP()

///////////////////////////////////////////////////////////////////////////////
// Get parameters of CPressPosModule 
BEGIN_GETOBJPARA_MAP(CPressPosModule)
	GETOBJPARA_DATAAREA_MAP()
///<AutoGeneratedContent id="GetObjectParameterMap">
	GETOBJPARA_VALUE(PID_TcTraceLevel, m_TraceLevelMax)
	GETOBJPARA_VALUE(PID_PressPosModuleDefaultAdsPort, m_DefaultAdsPort)
	GETOBJPARA_VALUE(PID_Ctx_AdsPort, m_ContextAdsPort)
	GETOBJPARA_VALUE(PID_PressPosModuleCounter, m_Counter)
	GETOBJPARA_VALUE(PID_PressPosModuleMyContextId, m_MyContextId)
	GETOBJPARA_ITFPTR(PID_Ctx_TaskOid, m_spCyclicCaller)
	GETOBJPARA_ITFPTR(PID_PressPosModulePostCyclicCaller, m_spPostCyclicCaller)
	GETOBJPARA_ITFPTR(PID_PressPosModuleIOSyncIntrf1, m_spIOSyncIntrf1)
///</AutoGeneratedContent>
	GETOBJPARA_TYPE_CODE(PID_PressPosModuleAdsPort, WORD, *p = AmsGetPort())
END_GETOBJPARA_MAP()

///////////////////////////////////////////////////////////////////////////////
// Get watch entries of CPressPosModule
BEGIN_OBJPARAWATCH_MAP(CPressPosModule)
	OBJPARAWATCH_DATAAREA_MAP()
///<AutoGeneratedContent id="ObjectParameterWatchMap">
	OBJPARAWATCH_VALUE(PID_PressPosModuleCounter, m_Counter)
///</AutoGeneratedContent>
END_OBJPARAWATCH_MAP()

///////////////////////////////////////////////////////////////////////////////
// Get data area members of CPressPosModule
BEGIN_OBJDATAAREA_MAP(CPressPosModule)
///<AutoGeneratedContent id="ObjectDataAreaMap">
	OBJDATAAREA_VALUE(ADI_PressPosModuleInputs, m_Inputs)
	OBJDATAAREA_VALUE(ADI_PressPosModuleOutputs, m_Outputs)
	OBJDATAAREA_VALUE(ADI_PressPosModuleDebug, m_Debug)
	OBJDATAAREA_VALUE(ADI_PressPosModulePressDriveVariables, m_PressDriveVariables)
///</AutoGeneratedContent>
END_OBJDATAAREA_MAP()


///////////////////////////////////////////////////////////////////////////////
CPressPosModule::CPressPosModule()
	: m_Trace(m_TraceLevelMax, m_spSrv)
	, m_log(0x12C)							//#@@# LTW
	, PressDriveMotionControl(m_Inputs.PressDriveInputs, m_Outputs.PressDriveOutputs, m_PressDriveVariables.DriveCommands, m_PressDriveVariables.MotionCommands, m_PressDriveVariables.VelocityInRPM, 1048576) //20 bit encoder on Yaskawa motor
{
///<AutoGeneratedContent id="MemberInitialization">
	...
	memset(&m_PressDriveVariables, 0, sizeof(m_PressDriveVariables));
///</AutoGeneratedContent>
...
// State Transitions 
///////////////////////////////////////////////////////////////////////////////
IMPLEMENT_ITCOMOBJECT_SETOBJSTATE_IP_PI(CPressPosModule)
...
// Allocate memory
HRESULT CPressPosModule::SetObjStatePS(PTComInitDataHdr pInitData)
{
...
HRESULT CPressPosModule::SetObjStateSO()
{
	m_Trace.Log(tlVerbose, FENTERA);
	HRESULT hr = S_OK;
...
HRESULT CPressPosModule::SetObjStateOS()
{
	m_Trace.Log(tlVerbose, FENTERA);
...
HRESULT CPressPosModule::SetObjStateSP()
{
	m_Trace.Log(tlVerbose, FENTERA);
...

HRESULT CPressPosModule::AddModuleToCaller()
{
	m_Trace.Log(tlVerbose, FENTERA);
...
///////////////////////////////////////////////////////////////////////////////
VOID CPressPosModule::RemoveModuleFromCaller()
{
	m_Trace.Log(tlVerbose, FENTERA);
...
HRESULT CPressPosModule::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	HRESULT hr = S_OK;
...
HRESULT CPressPosModule::AddModuleToPostCyclicCaller()
{
	m_Trace.Log(tlVerbose, FENTERA);
	HRESULT hr = S_OK;
...
VOID CPressPosModule::RemoveModuleFromPosyCyclicCaller()
{
	m_Trace.Log(tlVerbose, FENTERA);
...
//-- NOTE: 0.0.0.1 backup
//HRESULT v::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
//{
...
///<AutoGeneratedContent id="ImplementationOf_ITcPostCyclic">
HRESULT CPressPosModule::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	HRESULT hr = E_NOTIMPL;
	bool result = false;
	...
	if (result)
	{
		...
		PressDriveMotionControl.ProcessDriveCommands();
		m_PressDriveVariables.DriveStatus = PressDriveMotionControl.DriveStatus;
		if (m_PressDriveVariables.DriveStatus == DriveStatusEnum::Operational)
		{
			PressDriveMotionControl.ProcessMotionCommands();
		}
...
HRESULT CPressPosModule::AddModuleToIOSync()
{
...
void CPressPosModule::RemoveModuleFromIOSync()
{
	//m_Trace.Log(tlVerbose, FENTERA);
...
bool CPressPosModule::IsAddedToIOSync()
...
bool CPressPosModule::WaitTillInputReady(int time_out_usec)
{
	m_log.LogStart(1, 1);
...
void CPressPosModule::DelayUsec(int usec)
{
...
void CPressPosModule::DelayUsec(void)
{
...
//void CPressPosModule::delay_100nsec(ITcTask* ipTask)
//{
//	if (ipTask == NULL) return;
//
//	LONGLONG cur_pentium_time;
...
///////////////////////////////////////////////////////////////////////////////
void CPressPosModule::AdsReadWriteInd
(
	AmsAddr& rAddr, 
	ULONG invokeId, 
	ULONG indexGroup,
...
)
{
	...
	switch(indexGroup)
	{
	case PressPosModuleIndexGroup1:
		switch(indexOffset)
		{

		case PressPosModuleIndexOffset1:
		...
		case PressPosModuleIndexOffset2:
			m_Trace.Log(tlInfo, FNAMEA "oid=0x%08x indexGroup=0x%08x, indexOffset=0x%08x", 
				m_objId.value, indexGroup, indexOffset );
		...
		break;
	case PressPosModuleIndexGroup2:
		switch(indexOffset)
		{
...
void CPressPosModule::SubmitAdsReadReq()
{
	m_Trace.Log(tlVerbose, FENTERA);
	...
	{
		m_Trace.Log(tlInfo, FNAMEA "AdsReadReq by oid=0x%08x and pid=0x%08x", m_objId.value, PID_PressPosModuleAdsPort);
	}
	m_Trace.Log(tlVerbose, FLEAVEA);
}

///////////////////////////////////////////////////////////////////////////////
void CPressPosModule::AdsReadCon
(
	AmsAddr& rAddr,
	ULONG invokeId,
	ULONG nResult,
