...
class CPressPositionCtrl : public ITcOCFCtrlImpl<CPressPositionCtrl, CPressPositionClassFactory>
{
public:
	CPressPositionCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("PressPosition: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CPressPositionCtrl>;
